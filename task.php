...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($submittedPrompt)) {
        ...
        $finalPrompt = "Проверьте следующий код на правильность логики. Задание: Создайте базовую структуру веб-страницы с использованием HTML. Если код правильный, ответьте одним словом *Правильно*, если нет, то *Неправильно*: \n" . $submittedPrompt;
...
<body>
    <div class="container">
        <h1>Создайте базовую структуру веб-страницы с использованием HTML.</h1>
